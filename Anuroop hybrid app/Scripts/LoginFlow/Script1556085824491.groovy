...
CustomKeywords.'com.my.keywords.android.ScrollToElement.scrollListToElementWithText'('Logout')

Mobile.getAttribute(findTestObject('More Page/Logout'), 'text', 0)

Mobile.waitForElementPresent(findTestObject('More Page/Logout'), 0)

Mobile.tap(findTestObject('logoutPage/Logout'), 0)

Mobile.waitForElementPresent(findTestObject('logoutPage/Logout'), 0)

not_run: Mobile.getAttribute(findTestObject('logoutPage/Cancel'), 'text', 0)

Mobile.delay(1)

Mobile.verifyElementExist(findTestObject('Log_out - Logout'), 0)

Mobile.delay(1)

Mobile.tap(findTestObject('Log_out - Logout'), 0)

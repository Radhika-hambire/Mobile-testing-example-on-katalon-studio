...
CustomKeywords.'com.my.keywords.android.ScrollToElement.scrollListToElementWithText'('Events')

Mobile.waitForElementPresent(findTestObject('More Page/Events'), 0)

Mobile.delay(1)

Mobile.tap(findTestObject('More Page/Events'), 5)

CustomKeywords.'com.my.keywords.android.ScrollToElement.scrollListToElementWithText'('May 26, 2019 Caste No Bar Thet Bhet Program @ Pune')

Mobile.tap(findTestObject('EventsPage/Back_button'), 0)

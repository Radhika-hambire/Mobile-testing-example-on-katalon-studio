...
Mobile.waitForElementPresent(findTestObject('More Page/About'), 0)

Mobile.delay(1)

Mobile.tap(findTestObject('More Page/About'), 5)

Mobile.tap(findTestObject('More Page/About_page_back_button'), 0)

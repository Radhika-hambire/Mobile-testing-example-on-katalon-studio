...
Mobile.waitForElementPresent(findTestObject('Home Page/Messages'), 0)

Mobile.tap(findTestObject('Home Page/Messages'), 0)

Mobile.verifyElementNotVisible(findTestObject('Message_Page/Loading'), 0)

Mobile.delay(5)

CustomKeywords.'com.my.keywords.android.ScrollToTextElement.scrollListToElementWithText'('Testing Team')

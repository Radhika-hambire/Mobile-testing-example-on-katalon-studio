...
Mobile.waitForElementPresent(findTestObject('More Page/Recently Viewed'), 0)

Mobile.tap(findTestObject('More Page/Recently Viewed'), 0)

Mobile.waitForElementPresent(findTestObject('More Page/BackButton_Recently_viewed'), 0)

Mobile.tap(findTestObject('More Page/BackButton_Recently_viewed'), 0)
